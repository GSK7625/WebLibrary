...
public class LspTests
{
    ...
    {
        // ARRANGE: Tạo danh sách đa hình chứa lớp con vi phạm LSP
        var resources = new List<BadLibraryResource>
        {
            new BadPhysicalBook { Id = 1, Title = "C# 12 In A Nutshell", DailyRentalPrice = 5000m },
            new BadReferenceOnlyBook { Id = 2, Title = "Đại Nam Thực Lục (Bản Gốc)", DailyRentalPrice = 0m },
    ...
    public void LspCompliant_WhenDerivedClassesFulfillContract_ShouldSubstituteSeamlessly()
    {
        ...
        Assert.Equal(32000m, results[1].EstimatedFee); // (5 * 6000) + 2000 phụ phí
    }
